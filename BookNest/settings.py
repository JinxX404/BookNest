...
# Email configuration for password reset (add to bottom of settings.py)
# For development - using console backend
...
# DEFAULT_FROM_EMAIL = 'BookNest <noreply@booknest.com>'

# Django allauth settings for password reset
